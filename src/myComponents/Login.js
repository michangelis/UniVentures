...
const pageData = {
    ...
    headingText: "Sign In To UniVentures",
    socialButtons: [
        {
            ...
            <Container>
                <Content>
                        ...
                        <MainContent>
                            ...
                            <FormContainer>
                                ...
                                <p tw="mt-6 text-xs text-gray-600 text-center">
                                    <a href={pageData.forgotPasswordUrl} tw="border-b border-gray-500 border-dotted">
                                        Forgot Password ?
                                    </a>
                                </p>
                                <p tw="mt-8 text-sm text-gray-600 text-center">
                                    Dont have an account?{" "}
                                    <a href={pageData.signupUrl} tw="border-b border-gray-500 border-dotted">
                                        Sign Up
                                    </a>
                                </p>
                            </FormContainer>
                    ...
                    <IllustrationContainer>
                        <IllustrationImage imageSrc={pageData.illustrationImageSrc} />
                    </IllustrationContainer>
                </Content>
            </Container>
        </AnimationRevealPage>
