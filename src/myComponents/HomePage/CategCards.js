        ...
        <Container>
            <Content>
                <ThreeColumn>
                    ...
                    {categArray.map(categEvent => (
                        <CardColumn key={categEvent.id}>
                            <Card>
                                <CardImage imageSrc={categEvent.imageSrc} />
                                <CardText>
                                    <CardHeader>
                                        <CardCompany>{categEvent.company}</CardCompany>
                                        <CardType>{props.name}</CardType>
                                    </CardHeader>
                                    <CardTitle>{categEvent.name}</CardTitle>
                                    <CardMeta>
                                        <CardMetaFeature>
                                            <TimeIcon /> {categEvent.date}
                                        </CardMetaFeature>
                                        <CardMetaFeature>
