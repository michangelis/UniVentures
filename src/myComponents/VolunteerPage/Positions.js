...
const Card = styled.div`
  ...
  ${({ selected }) =>
          selected &&
          tw`border-solid bg-primary-500 border-4 text-secondary-100 transform hover:scale-110`}
`;
    ...
    return (
        <Container>
            <ThreeColumnContainer>
                <Heading><span tw="text-primary-500">Volunteering</span> Positions</Heading>
                {cards.map((card, i) => (
                    <Column key={i}>
                        <Card>
